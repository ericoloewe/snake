...
$(document).ready(function () {
    ...
    function init() {
        ...
        food.create_food(Math.round(Math.random() * (arena.width - arena.cellWidth) / arena.cellWidth), Math.round(Math.random() * (arena.height - arena.cellWidth) / arena.cellWidth));
    ...
    function paint() {
        ...
        if (snake.direction == Model.Direction.right)
            nx++;
        else if (snake.direction == Model.Direction.left)
            nx--;
        else if (snake.direction == Model.Direction.up)
            ny--;
        else if (snake.direction == Model.Direction.down)
            ny++;
        //Lets add the game over clauses now
        //This will restart the game if the snake hits the wall
        //Lets add the code for body collision
        //Now if the head of the snake bumps into its body, the game will restart
        if (nx == -1 || nx == arena.width / arena.cellWidth || ny == -1 || ny == arena.height / arena.cellWidth || check_collision(nx, ny, snake)) {
            //restart game
            init();
        ...
        for (var i = 0; i < snake.pointers.length; i++) {
            ...
            arena.paint_cell(c.x, c.y);
        }
        //Lets paint the food
        arena.paint_cell(food.pointers.x, food.pointers.y);
    ...
    $(document).keydown(function (e) {
        ...
        if (key == 37 && snake.direction != Model.Direction.right)
            snake.direction = Model.Direction.left;
        else if (key == 38 && snake.direction != Model.Direction.down)
            snake.direction = Model.Direction.up;
        else if (key == 39 && snake.direction != Model.Direction.left)
            snake.direction = Model.Direction.right;
        else if (key == 40 && snake.direction != Model.Direction.up)
            snake.direction = Model.Direction.down;
